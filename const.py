...
CONF_ZONE_TYPE = "type"                        # always "et0" — kept for backward compat
CONF_ZONE_FACTOR = "factor"                    # float 0.1–2.0 (ET adjustment, all zones)
CONF_ZONE_MIN_MINUTES = "min_minutes"          # int, minimum irrigation time (0 = no minimum)
CONF_ZONE_MAX_MINUTES = "max_minutes"          # int, maximum irrigation time per cycle (default: 30)
